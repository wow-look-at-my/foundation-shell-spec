...
The executable conformance suite ([dats](https://github.com/wow-look-at-my/dats)) lives in the **implementation repo** at `src/dats/`, where every build runs it against the built shell. Do not add a copy here — it would drift.
